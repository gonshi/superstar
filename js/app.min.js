!function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);var j=new Error("Cannot find module '"+g+"'");throw j.code="MODULE_NOT_FOUND",j}var k=c[g]={exports:{}};b[g][0].call(k.exports,function(a){var c=b[g][1][a];return e(c?c:a)},k,k.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(a,b,c){var d,e,f;f=a("./util/ticker")(),e=a("./util/social")(),d=function(){var a,b,c,d,g,h,i,j,k,l,m,n;for(c=$(".modal"),d=$(".youtube"),b=$(".comment_container"),a=b.find(".comment"),h=a.size(),g=[],n=null,i=j=0,k=h;k>=0?k>j:j>k;i=k>=0?++j:--j)g[i]={},g[i].start=a.eq(i).data("start"),g[i].shown=!1;return l=function(){return n=new YT.Player("youtube",{width:d.width(),height:d.height(),videoId:d.data("id"),playerVars:{rel:0,showinfo:0,modestbranding:1,controls:0,wmode:"opaque"}}),n.addEventListener("onReady",function(){return n.playVideo(),f.listen("CHECK_MOVIE_CURTIME",function(){var a,b,c;for(a=n.getCurrentTime(),i=b=c=h-1;0>=c?0>=b:b>=0;i=0>=c?++b:--b){if(g[i].shown)return;if(a>g[i].start)return g[i].shown=!0,void m(i)}})}),n.addEventListener("onStateChange",function(a){return a.data===YT.PlayerState.ENDED?c.velocity({opacity:[0,1]},2*DUR,function(){return c.hide()}):void 0})},m=function(c){return a.eq(c).css({display:"table-cell"}),b.velocity({opacity:[1,0]},2*DUR),setTimeout(function(){return b.velocity({opacity:[0,1]},DUR,function(){return a.eq(c).hide()})},4e3)},window.onYouTubeIframeAPIReady=function(){return l()},$("<script>").attr({src:"https://www.youtube.com/iframe_api"}).insertBefore($("script").eq(0)),e.exec("fb","tweet")},b.exports=d},{"./util/social":3,"./util/ticker":4}],2:[function(a,b,c){/*!
  *
