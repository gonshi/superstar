...
/*!
  ...
  *
 */
var d,e,f,g,h;window._DEBUG?null!=Object.freeze?window.DEBUG=Object.freeze(window._DEBUG):window.DEBUG={state:!0}:null!=Object.freeze?window.DEBUG=Object.freeze({state:!1}):window.DEBUG={state:!1},a("../js/velocity.min.js"),h=a("./util/social")(),e=a("./model/episodeData")(),g=a("./view/search")(),d=a("./view/bg")(),f=a("./controller/resizeHandler")(),window.DUR=500,window.ENTER_KEY=13,window.path="./",$(function(){var a,b,c,i,j,k,l,m;return j=$(window),k=$(".wrapper"),c=$(".lock"),i=$(".password_container"),b=i.find(".password"),a=i.find(".enter"),window.NOT_YAHOO=location.search.match("not_yahoo")?!0:!1,isSp&&(window.NOT_YAHOO=!0),l=!1,m=function(){var a;return a=CryptoJS.SHA256(b.val()),"a40a253fff002b6a8b08e9668c151b4a7696204765d57afb7f294e0248d56395"===a.toString()?c.velocity({opacity:[0,1]},function(){return c.hide()}):i.velocity({translateX:[5,0]},DUR/10).velocity({translateX:[-5,5]},DUR/10).velocity({translateX:[5,-5]},DUR/10).velocity({translateX:[0,5]},DUR/10)},b.one("focus",function(){return b.attr({type:"password"}).val("")}),a.on("click",function(){return m()}),$(window).on("keydown",function(a){return a.keyCode===ENTER_KEY?m():void 0}),e.listen("GOT_DATA",function(a){return g.setEpisode(a),d.setPortrait(a)}),d.listen("LOAD_IMG",function(a,b){return g.setPortrait(a,b)}),f.listen("RESIZED",function(){var a,b,c,e;return l&&location.reload(),b=j.width(),a=j.height(),e=k.width(),c=k.height(),g.setWinWidth(b),d.setSize(e,c),d.arragePortrait()}),d.listen("PORTRAIT_CLICKED",function(a,b){return g.showResult(a,b)}),d.listen("PORTRAIT_COUNTED",function(a){return g.setPortraitMax(a)}),g.listen("FIN_INTRO",function(){return l=!1,d.finIntro()}),location.search.match("skip")?(window.skip=!0,window.DUR=10):window.skip=!1,h.exec("fb","tweet"),f.dispatch("RESIZED"),f.exec(),g.exec(),g.showIntro(),e.getData(),l=!0,window.DEBUG.state?c.velocity({opacity:[0,1]},function(){return c.hide()}):void 0})},{"../js/velocity.min.js":10,"./controller/resizeHandler":1,"./model/episodeData":3,"./util/social":5,"./view/bg":8,"./view/search":9}],3:[function(a,b,c){var d,e,f,g,h=function(a,b){function c(){this.constructor=a}for(var d in b)i.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a},i={}.hasOwnProperty;e=a("../util/eventDispatcher"),g=null,d=function(a){function b(){b.__super__.constructor.call(this),this.episode={},this.ageExp=/年齢: (.*?),/,this.episodeExp=/一言エピソード: (.*?),/,this.birthExp=/生年: (.*?),/,this.portraitExp=/画像: (.*?)$/,this.END_PHRASE="以下未記述欄",window.gdata={},window.gdata.io={},window.gdata.io.handleScriptLoaded=function(a){return function(b){var c,d,e,f,g,h,i;for(d=b.feed.entry.length,g=h=0,i=d;(i>=0?i>h:h>i)&&(b.feed.entry[g].content.$t=b.feed.entry[g].content.$t.replace(/\n/g,""),b.feed.entry[g].title.$t!==a.END_PHRASE);g=i>=0?++h:--h)c=b.feed.entry[g].content.$t.match(a.ageExp)[1],f=b.feed.entry[g].content.$t.match(a.portraitExp)[1],e="なし"!==f?path+"img/portrait/"+f+".png":"",null==a.episode[c]&&(a.episode[c]=[]),a.episode[c].push({id:a.episode[c].length,name:b.feed.entry[g].title.$t,episode:b.feed.entry[g].content.$t.match(a.episodeExp)[1],birth:b.feed.entry[g].content.$t.match(a.birthExp)[1],portrait:e});return a.dispatch("GOT_DATA",a,a.episode)}}(this)}return h(b,a),b.prototype.getData=function(){return this.src="https://spreadsheets.google.com/feeds/list/1ThmwlEue4zVhhlFMw7BsQd2Acpiv4Z4Uxz-5oYUlkaM/od6/public/basic?alt=json-in-script",$("head").append($("<script>").attr({src:this.src}))},b}(e),f=function(){return g||(g=new d),g},b.exports=f},{"../util/eventDispatcher":4}],4:[function(a,b,c){var d,e=[].slice;d=function(){function a(){this.listeners={},this.dispatched={}}return a.prototype.listen=function(a,b){return null!=this.listeners[a]?this.listeners[a].push(b):this.listeners[a]=[b]},a.prototype.dispatch=function(){var a,b,c,d,f,g,h,i;if(b=arguments[0],g=arguments[1],a=3<=arguments.length?e.call(arguments,2):[],this.listeners[b]){for(h=this.listeners[b],i=[],c=0,d=h.length;d>c;c++)f=h[c],i.push(f.apply(g||this,a));return i}},a.prototype.first=function(){var a,b,c,d,f,g,h,i;if(b=arguments[0],g=arguments[1],a=3<=arguments.length?e.call(arguments,2):[],this.listeners[b]&&null==this.dispatched[b]){for(this.dispatched[b]=!0,h=this.listeners[b],i=[],c=0,d=h.length;d>c;c++)f=h[c],i.push(f.apply(g||this,a));return i}},a.prototype.clear=function(a){return null!=a?this.listeners[a]=null:this.listeners={}},a}(),b.exports=d},{}],5:[function(a,b,c){var d,e,f;f=null,d=function(){function a(){}return a.prototype.exec=function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u;for(b={},d=g=0,n=arguments.length;n>=0?n>g:g>n;d=n>=0?++g:--g)b[arguments[d]]=!0;if(null!=b.fb){for(a=document.querySelectorAll(".fb-like"),d=h=0,o=a.length;o>=0?o>h:h>o;d=o>=0?++h:--h)a[d].style.opacity=1;if(c=document.getElementsByTagName("script")[0],document.getElementById("facebook-jssdk"))return;f=document.createElement("script"),f.id="facebook-jssdk",f.src="//connect.facebook.net/ja_JP/sdk.js#xfbml=1&appId=959877374073274&version=v2.0",c.parentNode.insertBefore(f,c)}if(null!=b.tweet){for(a=document.querySelectorAll(".tweet"),d=i=0,p=a.length;p>=0?p>i:i>p;d=p>=0?++i:--i)a[d].style.opacity=1;window.twttr=function(){var a;return c=document.getElementsByTagName("script")[0],document.getElementById("twitter-wjs")?void 0:(f=document.createElement("script"),f.id="twitter-wjs",f.src="https://platform.twitter.com/widgets.js",c.parentNode.insertBefore(f,c),null!=window.twttr?window.twttr:a={_e:[],ready:function(b){return a._e.push(b)}})}()}if(null!=b.hatena){for(a=document.querySelectorAll(".hatena"),d=j=0,q=a.length;q>=0?q>j:j>q;d=q>=0?++j:--j)a[d].style.opacity=1;e=document.createElement("script"),e.type="text/javascript",e.src="https://b.st-hatena.com/js/bookmark_button.js",e.async="async",e.charset="utf-8",t=document.getElementsByTagName("script")[0],t.parentNode.insertBefore(e,t)}if(null!=b.pocket){for(a=document.querySelectorAll(".pocket"),d=k=0,r=a.length;r>=0?r>k:k>r;d=r>=0?++k:--k)a[d].style.opacity=1;document.getElementById("pocket-btn-js")||(e=document.createElement("script"),e.id="pocket-btn-js",e.type="text/javascript",e.src="https://widgets.getpocket.com/v1/j/btn.js?v=1",u=document.getElementById("pocket-btn-js"),document.body.appendChild(e))}if(null!=b.gplus){for(a=document.querySelectorAll(".gplus"),d=l=0,s=a.length;s>=0?s>l:l>s;d=s>=0?++l:--l)a[d].style.opacity=1;m=document.createElement("script"),m.type="text/javascript",m.async=!0,m.src="https://apis.google.com/js/plusone.js",t=document.getElementsByTagName("script")[0],t.parentNode.insertBefore(m,t)}if(null!=b.fb_share&&null==b.fb){if(c=document.getElementsByTagName("script")[0],document.getElementById("facebook-jssdk"))return;f=document.createElement("script"),f.id="facebook-jssdk",f.src="//connect.facebook.net/ja_JP/sdk.js#xfbml=1&appId=959877374073274&version=v2.0",c.parentNode.insertBefore(f,c)}return $(".facebook").on("click",function(a){return FB.ui({display:"popup",method:"feed",link:$(a.target).attr("data-url"),name:$(a.target).attr("data-name"),picture:$(a.target).attr("data-picture"),description:$(a.target).attr("data-description")})}),$(".tweet a").on("click",function(a){var b,c,d,e,f,g,h,i,j;return a.preventDefault(),null!=window.screenLeft?(b=window.screenLeft,c=window.screenTop):(b=window.screen.left,c=window.screen.top),"undefined"!=typeof innerWidth&&null!==innerWidth?(i=window.innerWidth,h=window.innerHeight):null!=(null!=(j=document.documentElement)?j.clientWidth:void 0)?(i=document.documentElement.clientWidth,i=document.documentElement.clientHeight):(i=window.screen.width,i=window.screen.height),f=650,e=450,d=i/2-f/2+b,g=h/2-e/2+c,window.open($(a.currentTarget).attr("href"),"twitter","width="+f+", height="+e+", "+("top="+g+", left="+d))})},a.prototype.callback=function(){var a;return window.twttr.ready(function(b){return b.events.bind("tweet",function(){return a("tw")})}),window.onload=function(){return window.FB.Event.subscribe("edge.create",function(b){return b?a("fb"):void 0})},a=function(a){return console.log(a)}},a}(),e=function(){return f||(f=new d),f},b.exports=e},{}],6:[function(a,b,c){var d;d=function(){function a(a){this.is_first=!0,this.interval=a,this.prevTime=0,this.timer=null}var b;return null!=(null!=(b=window.performance)?b.now:void 0)?window.getNow=function(){return window.performance.now()}:window.getNow=function(){return Date.now()},a.prototype.exec=function(a){var b,c;return c=window.getNow(),b=c-this.prevTime,clearTimeout(this.timer),b>=this.interval?(this.prevTime=c,a()):this.timer=setTimeout(function(){return a()},this.interval)},a.prototype.first=function(a){return this.is_first?(this.is_first=!1,a()):(clearTimeout(this.firstTimer),this.firstTimer=setTimeout(function(a){return function(){return a.is_first=!0}}(this),this.interval))},a.prototype.last=function(a){return clearTimeout(this.lastTimer),this.lastTimer=setTimeout(function(){return a()},this.interval)},a.prototype.triggerend=function(){return this.is_first=!0},a}(),b.exports=d},{}],7:[function(a,b,c){var d,e,f;f=null,d=function(){function a(){var a;this.listeners={},this.start={},(a=function(b){return function(){var c;for(c in b.listeners)b.listeners[c](window.getNow()-b.start[c]);return window.requestAnimFrame(a)}}(this))()}var b;return null!=(null!=(b=window.performance)?b.now:void 0)?window.getNow=function(){return window.performance.now()}:window.getNow=function(){return Date.now()},null!=window.requestAnimationFrame?window.requestAnimFrame=window.requestAnimationFrame:null!=window.webkitRequestAnimationFrame?window.requestAnimFrame=window.webkitRequestAnimationFrame:null!=window.mozRequestAnimationFrame?window.requestAnimFrame=window.mozRequestAnimationFrame:window.requestAnimFrame=function(a){return window.setTimeout(a,1e3/60)},a.prototype.listen=function(a,b){return this.start[a]=window.getNow(),this.listeners[a]=b},a.prototype.clear=function(a){return null!=a?(delete this.listeners[a],delete this.start[a]):(this.listeners={},this.start={})},a}(),e=function(){return f||(f=new d),f},b.exports=e},{}],8:[function(a,b,c){var d,e,f,g,h=function(a,b){function c(){this.constructor=a}for(var d in b)i.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a},i={}.hasOwnProperty;e=a("../util/eventDispatcher"),g=null,d=function(a){function b(){b.__super__.constructor.call(this),this.$wrapper=$(".wrapper"),this.$portrait_container=$(".portrait_container"),this.ROW_MAX=20,this.FOOTER_HEIGHT=145,this.PORTRAIT_HEIGHT=$(".portrait").height(),this.PORTRAIT_ROW_MARGIN=parseInt($(".portrait_row").css("margin-top")),this.mouseover_sound=new Audio,this.mouseover_sound.src="audio/mouseover.mp3",this.mouseover_sound.volume=.2,this.open_sound=new Audio,this.open_sound.src="audio/open.mp3",this.loaded_src={},this.is_intro=!0}return h(b,a),b.prototype.finIntro=function(){return this.is_intro=!1},b.prototype.imgLoaded=function(a){var b;return b=function(b){return function(){return b.is_intro?b.dispatch("LOAD_IMG",b,b.img[a].src,a):$(".portrait_pic_"+a).addClass("show"),b.portrait_shown_num+=1,null!==b.portrait_num&&b.portrait_shown_num===b.portrait_num?b.dispatch("FIN_ARRANGE"):void 0}}(this),this.img[a].complete&&b(),this.img[a].onload=function(){return b()}},b.prototype.setPortrait=function(a){return this.data=a,this.arragePortrait()},b.prototype.arragePortrait=function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r;if(null!=this.data&&null!=this.wrapper_width){e=0,d=$("<div>").attr({"class":"portrait_row"}),c=[],k=Math.floor((this.wrapper_height-this.FOOTER_HEIGHT)/(this.PORTRAIT_HEIGHT+this.PORTRAIT_ROW_MARGIN)),i=0,h=[];for(m in this.data)i+=1,h.push(m);for(f=0,g=0,j=0,this.$portrait_container.empty(),this.portrait_shown_num=0,this.portrait_num=null,this.img=[];k>f;){for(n=o=0,q=this.data[h[g]].length;q>=0?q>o:o>q;n=q>=0?++o:--o)if(""!==this.data[h[g]][n].portrait&&(b=$("<p>").attr({"class":"portrait"}),a=$("<button>"),this.img.push(new Image),l=""+this.data[h[g]][n].portrait,this.img[this.img.length-1].setAttribute("data-age",h[g]),this.img[this.img.length-1].setAttribute("data-id",n),null!=this.loaded_src[l]?this.img[this.img.length-1].src=""+l:(this.img[this.img.length-1].src=""+l,this.loaded_src[l]=Date.now()),this.img[this.img.length-1].className+=" portrait_pic_"+(this.img.length-1),a.append(this.img[this.img.length-1]),b.append(a),c.push(b.clone()),b.appendTo(d),e+=1,e===this.ROW_MAX)){for(e=0,m=p=0,r=this.ROW_MAX;r>=0?r>p:p>r;m=r>=0?++p:--p)c[m].appendTo(d),this.imgLoaded(this.img.length-1-m);c=[],d.appendTo(this.$portrait_container),d.css({width:b.outerWidth(!0)*this.ROW_MAX*2}),d.addClass("anim"),d=$("<div>").attr({"class":"portrait_row"}),f+=1}g+=1,g===i&&(g=0)}return this.portrait_num=this.$portrait_container.find(".portrait").size(),this.dispatch("PORTRAIT_COUNTED",this,this.portrait_num),this.$portrait_container.css({marginTop:(this.wrapper_height-this.FOOTER_HEIGHT-this.$portrait_container.height())/2}),this.$portrait=$(".portrait"),this.$portrait.on("click",function(a){return function(b){return a.open_sound.currentTime=0,a.open_sound.play(),a.dispatch("PORTRAIT_CLICKED",a,$(b.currentTarget).find("img").attr("data-age"),$(b.currentTarget).find("img").attr("data-id"))}}(this)),this.$portrait.on("mouseenter",function(a){return function(){return a.mouseover_sound.currentTime=0,a.mouseover_sound.play()}}(this))}},b.prototype.setSize=function(a,b){return this.wrapper_width=a,this.wrapper_height=b},b}(e),f=function(){return g||(g=new d),g},b.exports=f},{"../util/eventDispatcher":4}],9:[function(a,b,c){var d,e,f,g,h,i=function(a,b){function c(){this.constructor=a}for(var d in b)j.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a},j={}.hasOwnProperty;d=a("../util/eventDispatcher"),h=a("../util/ticker")(),g=null,e=function(a){function b(){var a;b.__super__.constructor.call(this),this.$win=$(window),this.$search_container=$(".search_container"),this.$search=this.$search_container.find(".search"),this.$enter=this.$search_container.find(".enter"),this.$result_container=$(".result_container"),this.$result=this.$result_container.find(".result"),this.$portrait=this.$result.find(".portrait"),this.$name=this.$result.find(".name"),this.$episode=this.$result.find(".episode"),this.$age_num=this.$result.find(".age_container .num"),this.$link=this.$result.find(".link"),this.$tweet_a=this.$result.find(".tweet a"),this.$facebook=this.$result.find(".facebook"),this.$year_container=$(".year_container"),this.$year_bar=$(".year_bar"),this.$year=this.$year_container.find(".year"),this.$pin=this.$year_container.find(".pin"),this.YEAR_WIDTH=parseInt(this.$year.eq(1).css("left"))/10,this.PIN_WIDTH=parseInt(this.$pin.width()),this.$portrait_container=$(".portrait_container"),this.is_diffusing=!1,this.portrait_loaded=[],this.cur_year_left=0,this.RESULT_PADDING_HEIGHT=isSp?360:247,this.ESCAPE_KEYCODE=27,this.WIKI_LINK_ORIGIN="https://ja.wikipedia.org/wiki/",this.win_width=null,this.$illust_container=$(".illust_container"),this.ILLUST_NAME={wright:"ライト兄弟",columbus:"コロンブス",oh:"王貞治",newton:"ニュートン",beethoven:"ベートーベン",zuckerberg:"マーク・ザッカーバーグ"},this.ILLUST_NAME_ARR=[];for(a in this.ILLUST_NAME)this.ILLUST_NAME_ARR.push(a);this.roulette_sound=new Audio,this.roulette_sound.src="audio/roulette.mp3",this.roulette_sound.volume=.2,this.open_sound=new Audio,this.open_sound.src="audio/open.mp3",this.close_sound=new Audio,this.close_sound.src="audio/close.mp3",this.loaded_portrait_num=0,this.oh_sound=new Audio,this.oh_sound.src="audio/oh.mp3",this.beethoven_sound=new Audio,this.beethoven_sound.src="audio/beethoven.mp3",this.wright_sound=new Audio,this.wright_sound.src="audio/wright.mp3"}return i(b,a),b.prototype.animIllust=function(a){var b,c,d,e,f,g;for(d=e=0,g=this.ILLUST_NAME_ARR.length;g>=0?g>e:e>g;d=g>=0?++e:--e)if(this.ILLUST_NAME_ARR[d]===a){this.ILLUST_NAME_ARR.splice(d,1);break}switch(skip&&(window.DUR=500),this.$anim_illust=this.$illust_container.find(".illust-"+a),a){case"wright":return this.wright_sound.play(),this.$anim_illust.show().velocity({translateX:[-this.$win.width()-1e3,0],translateY:[300,0]},7*DUR,"easeInSine",function(b){return function(){return b.showResultByName(a)}}(this));case"columbus":return this.$anim_illust.show().removeClass("break").velocity({translateY:[this.$win.height()-this.$year_container.height()+80,0]},2*DUR,"easeInCubic",function(a){return function(){return a.$anim_illust.css({translateY:a.$win.height()-a.$year_container.height()+60}).addClass("break")}}(this)),setTimeout(function(b){return function(){return b.showResultByName(a)}}(this),4*DUR);case"oh":return this.oh_sound.play(),this.$anim_illust.show().velocity({translateX:[this.$win.width()+1e3,0],translateY:[-this.$win.height()+this.$year_container.height(),0],rotateZ:[-720,0]},4*DUR,"easeOutSine",function(b){return function(){return b.showResultByName(a)}}(this));case"newton":return this.$anim_illust.show().removeClass("fall"),this.$anim_illust.find(".illust-newton_tree").show(),b=1,c=setInterval(function(d){return function(){return 5>b?d.$anim_illust.find(".illust-newton_chara_container").attr({"data-id":b%2+1}).css({left:-50+100*b}):5===b&&d.$anim_illust.find(".illust-newton_chara_container").attr({"data-id":3}),7===b&&(clearInterval(c),d.$anim_illust.addClass("fall"),setTimeout(function(){return d.showResultByName(a)},4*DUR)),b+=1}}(this),400);case"beethoven":for(this.beethoven_sound.volume=0,$(this.beethoven_sound).animate({volume:1},4*DUR),this.beethoven_sound.play(),this.$anim_illust.show(),d=f=0;4>f;d=++f)this.$anim_illust.find("img").eq(d).velocity({translateX:[-this.$win.width()-1e3,0]},{queue:!1,duration:12*DUR,easing:"linear",complete:function(a){return function(){return $(a.beethoven_sound).animate({volume:0},4*DUR,function(){return a.beethoven_sound.stop()})}}(this)}),this.$anim_illust.find(".illust-beethoven_tone").eq(d).velocity({translateY:50+150*Math.random()},{duration:DUR+Math.random()*DUR*2,loop:!0,easing:"linear"});return setTimeout(function(b){return function(){var c;for(d=c=0;4>c;d=++c)b.$anim_illust.find(".illust-beethoven_tone").eq(d).velocity("stop");return b.showResultByName(a)}}(this),12*DUR);case"zuckerberg":return this.$anim_illust.show().velocity({translateX:[-600,0]},DUR,function(b){return function(){return b.showResultByName(a)}}(this))}},b.prototype.diffusePortrait=function(a){var b,c,d,e,f,g,h,i,j,k,l;for(g=this.$result.get(0).getBoundingClientRect(),e=this.$portrait_container.find(".portrait_row").width(),l=[],i=j=0,k=a;k>=0?k>j:j>k;i=k>=0?++j:--j){for(;;)if(c=0===i?a-1:Math.floor(Math.random()*this.$portrait.find("img").size()),!this.$portrait.find("img").eq(c).hasClass("selected"))break;for(b=this.$portrait.find("img").eq(c),b.addClass("selected"),d=b.attr("data-id");;)if(f=Math.floor(Math.random()*this.$portrait_container.find(".portrait_pic_"+d).size()),h=this.$portrait_container.find(".portrait_pic_"+d).get(f),!h.className.match("selected"))break;h.className+=" selected",l.push(function(a){return function(b,c){var d,f,h,j,k,l;return skip?(f=0,d=0):(f=6*DUR,d=10*i),l=$(c).parents(".portrait_row").index()%2===0?-1:1,h=c.getBoundingClientRect().left+e/2/150*((f+d)/1e3)*l,k=c.getBoundingClientRect().top,j=h+c.offsetWidth>g.left&&h<g.right&&k+c.offsetHeight>g.top&&k<g.bottom?.02:.2,isSp?(b.css({position:"fixed",top:k,left:h,width:c.offsetWidth,height:c.offsetHeight}),$(c).velocity({opacity:[1,0]},f,function(){return b.remove(),$(c).removeAttr("style"),c.className+=" show",a.is_diffusing=!1})):(b.css({position:"fixed",top:b.get(0).getBoundingClientRect().top,left:b.get(0).getBoundingClientRect().left,width:b.width(),height:b.height()}).velocity({left:h,width:c.offsetWidth,height:c.offsetHeight,opacity:[j,0]},{duration:f,delay:d,easing:"easeOutSine",complete:function(){return b.remove(),c.className+=" show",a.is_diffusing=!1}}),b.velocity({top:k},{duration:f,delay:d,easing:"easeInSine",queue:!1}))}}(this)(b,h))}return l},b.prototype.setEpisode=function(a){return this.episode=a,this.origin_episode=$.extend(!0,{},a)},b.prototype.setPortrait=function(a,b){var c,d,e,f;if(a){for(c=new Image,c.src=a,c.setAttribute("data-id",b),f=[],d=e=0;2>e;d=++e)this.$portrait.append($(c).clone()),this.loaded_portrait_num+=1,this.loaded_portrait_num===Math.floor(this.PORTRAIT_MAX/3)?f.push(this.portrait_loaded[0]=!0):this.loaded_portrait_num===Math.floor(2*this.PORTRAIT_MAX/3)?f.push(this.portrait_loaded[1]=!0):this.loaded_portrait_num===this.PORTRAIT_MAX?f.push(this.portrait_loaded[2]=!0):f.push(void 0);return f}},b.prototype.dropPin=function(a){var b;return this.$pin.css({left:this.YEAR_WIDTH*a-this.PIN_WIDTH/2,opacity:0}),b=this.win_width/2-this.$pin.get(0).getBoundingClientRect().left+this.cur_year_left,this.$year_bar.velocity({translateX:b},2*DUR,function(a){return function(){return a.cur_year_left=b,a.$pin.velocity({opacity:[1,0],translateY:[0,-20]},DUR,[200,10],function(){return a.$result_container.removeClass("is_animating")})}}(this))},b.prototype.search=function(a){return this.search_interval?void 0:(this.open_sound.currentTime=0,this.open_sound.play(),this.search_interval=setInterval(function(b){return function(){var c;if(null!=b.episode){if(clearInterval(b.search_interval),b.search_interval=null,null==b.episode[a])return void alert("該当する人物なし");if(c=Math.floor(Math.random()*b.episode[a].length),b.showResult(a,b.episode[a][c].id),b.episode[a].splice(c,1),0===b.episode[a].length)return b.episode[a]=$.extend(!0,[],b.origin_episode[a])}}}(this),200))},b.prototype.setPortraitMax=function(a){return this.PORTRAIT_MAX=a},b.prototype.showIntro=function(){var a;return this.$result_container.removeClass("withoutPortrait").addClass("is_animating"),this.$name.text("ここに出てくる偉人はみんな"),this.$name.css({fontSize:28}),this.$result.find(".name_particle").hide(),this.$result_container.show().velocity({opacity:[1,0]},DUR,function(a){return function(){return a.$result_container.removeClass("is_animating"),a.roulette_sound.play(),h.listen("AGE_COUNTUP",function(b){var c;return c=Math.floor(b/30),c>0?(h.clear("AGE_COUNTUP"),a.roulette_sound.pause(),a.roulette_sound.currentTime=0):a.$age_num.text(c)})}}(this)),a=skip?2e3:8e3,h.listen("TIMER_FROM_START",function(b){return function(c){var d,e,f;for(e=f=0;3>f;e=++f)if(c>a*e&&b.portrait_loaded[e]){if(b.is_diffusing||1===e&&null!==b.portrait_loaded[0]||2===e&&null!==b.portrait_loaded[1])return;switch(d=2===e?b.PORTRAIT_MAX-2*Math.floor(1*b.PORTRAIT_MAX/3):Math.floor(1*b.PORTRAIT_MAX/3),b.portrait_loaded[e]=null,b.$age_num.text(e),e){case 0:b.$episode.text("初めて泣いた。");break;case 1:b.$episode.text("夢を見た。");break;case 2:b.$episode.text("笑った。"),h.clear("TIMER_FROM_START")}b.$result.css({height:b.$result.find(".info").height()+b.RESULT_PADDING_HEIGHT,opacity:1}),b.$result.find(".info").velocity({opacity:1},4*DUR),b.is_diffusing=!0,function(a){return setTimeout(function(){return b.diffusePortrait(d),b.$result.find(".info").velocity({opacity:0},{duration:4*DUR,delay:2*DUR})},6*DUR),2===a?setTimeout(function(){var a,c;return b.$result.velocity({backgroundColorAlpha:0,borderColorAlpha:0},DUR),isSp?(c=490,a=150):(c=580,a=35),b.$result.find(".logo").velocity({width:c,height:300*c/580,bottom:a},{duration:2*DUR,delay:2*DUR,complete:function(){return b.$result.find(".logo").velocity({opacity:0},{duration:2*DUR,delay:6*DUR,complete:function(){return b.$result_container.velocity({opacity:[0,1]},2*DUR,function(){return b.$result_container.hide(),b.$result.removeAttr("style"),b.$result.find(".info").removeAttr("style"),b.$result.find(".logo").removeAttr("style"),b.$result.find(".name_particle").show(),b.$result.find(".social_container").show(),b.dispatch("FIN_INTRO"),b.anim_timer=setTimeout(function(){return b.animIllust(b.ILLUST_NAME_ARR[Math.floor(Math.random()*b.ILLUST_NAME_ARR.length)])},5e3*Math.random()+5e3),b.fin_intro=!0}),b.showSearchBar()}})}})},18*DUR):void 0}(e)}}}(this))},b.prototype.showResultByName=function(a){var b,c,d,e;for(b in this.episode)for(c=d=0,e=this.episode[b].length;e>=0?e>d:d>e;c=e>=0?++d:--d)if(this.episode[b][c].name===this.ILLUST_NAME[a])return void this.showResult(b,c)},b.prototype.showResult=function(a,b){var c,d;return null!=this.anim_timer&&clearTimeout(this.anim_timer),"block"!==this.$result_container.css("display")?(d=this.origin_episode[a][b],this.$result_container.removeClass("withoutPortrait").addClass("is_animating"),this.$name.text(d.name),this.$episode.html(d.episode),this.$age_num.text("0"),this.$link.find("a").attr({href:""+this.WIKI_LINK_ORIGIN+encodeURIComponent(d.name)}),this.$tweet_a.attr({href:"http://twitter.com/share?url="+this.$tweet_a.attr("data-url")+("&text="+encodeURIComponent(this.$result.find(".info").text().replace(/\n| |　/g,"")+" - "+this.$tweet_a.attr("data-title")))}),this.$facebook.attr({"data-description":this.$result.find(".info").text().replace(/\n| |　/g,"")}),d.name.length>11?this.$name.css({fontSize:28}):d.name.length>10?this.$name.css({fontSize:32}):this.$name.css({fontSize:36}),this.$result.css({height:this.$result.find(".info").height()+this.RESULT_PADDING_HEIGHT,opacity:1}),this.$result.find(".info").css({opacity:1}),this.$result.find(".portrait").show(),d.portrait.length>0?(c=new Image,c.src=d.portrait,c.style.opacity=1,this.$portrait.empty(),this.$portrait.append(c)):this.$result_container.addClass("withoutPortrait"),this.$result_container.show().velocity({opacity:[1,0]},DUR,function(b){return function(){return"不明"!==d.birth?b.dropPin(parseInt(a)+parseInt(d.birth)):b.$result_container.removeClass("is_animating"),b.roulette_sound.play(),h.listen("AGE_COUNTUP",function(c){var d;return d=Math.floor(c/30),d>a?(h.clear("AGE_COUNTUP"),b.roulette_sound.pause(),b.roulette_sound.currentTime=0,NOT_YAHOO?void 0:setTimeout(function(){return skip?void 0:b.$result.velocity({width:720,height:450},DUR,function(){return b.$result.find(".info, .portrait, .logo").velocity({opacity:0},DUR,function(){return b.$result.find(".info, .portrait, .logo").hide(),b.$result.find(".yahoo-msg").show().velocity({opacity:1},function(){return setTimeout(function(){return b.$result.find(".yahoo-msg-2").addClass("underline")},2*DUR)},DUR)})})},10*DUR)):b.$age_num.text(d)})}}(this)),this.$result.css({height:this.$result.find(".info").height()+this.RESULT_PADDING_HEIGHT})):void 0},b.prototype.closeResult=function(){return NOT_YAHOO&&null!=this.fin_intro?(this.close_sound.currentTime=0,this.close_sound.play(),this.$pin.velocity({opacity:[0,1]},DUR),this.$result_container.velocity({opacity:[0,1]},DUR,function(a){return function(){return a.$result_container.hide(),null!=a.$anim_illust&&a.$anim_illust.hide(),a.ILLUST_NAME_ARR.length>0?a.anim_timer=setTimeout(function(){return a.animIllust(a.ILLUST_NAME_ARR[Math.floor(Math.random()*a.ILLUST_NAME_ARR.length)])},5e3*Math.random()+5e3):void 0}}(this))):void 0},b.prototype.setWinWidth=function(a){return this.win_width=a},b.prototype.showSearchBar=function(){return 0===parseInt(this.$search_container.css("opacity"))?this.$search_container.velocity({translateY:[0,-20],opacity:[1,0]},4*DUR):void 0},b.prototype.exec=function(){return this.$search.one("click",function(a){return function(){return a.$search.attr({type:"number"}).val("").addClass("on")}}(this)),this.$result_container.on("click",function(a){return function(b){return a.$result_container.hasClass("is_animating")?void 0:$(b.target).hasClass("close")?a.closeResult():void 0}}(this)),this.$win.on("keydown",function(a){return function(b){return a.$result_container.hasClass("is_animating")?void 0:b.keyCode===a.ESCAPE_KEYCODE?a.closeResult():void 0}}(this)),this.$enter.on("click",function(a){return function(){return a.search(a.$search.val())}}(this)),$(window).on("keydown",function(a){return function(b){return b.keyCode===ENTER_KEY?a.search(a.$search.val()):void 0}}(this))},b}(d),f=function(){return g||(g=new e),g},b.exports=f},{"../util/eventDispatcher":4,"../util/ticker":7}],10:[function(a,b,c){/*! VelocityJS.org (1.2.2). (C) 2014 Julian Shapiro. MIT @license: en.wikipedia.org/wiki/MIT_License */
